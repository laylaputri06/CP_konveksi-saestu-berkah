    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-card">
                <div class="row align-items-center">
                    <div class="col-md-7">
                        <h3 class="vm-title">PARTNER KAMI</h3>
                        <p class="welcome-desc">
                            Saat ini terdapat <strong><?= count($partner); ?> Partner</strong> yang terdaftar di sistem. 
                            Partner ini ditampilkan pada halaman beranda dalam bentuk slider otomatis.
                        </p>
                        <div class="d-flex gap-2 flex-wrap mt-3">
                            <?php 
                            // Menampilkan 5 logo pertama sebagai preview di admin
                            $preview_partner = array_slice($partner, 0, 5);
                            foreach($preview_partner as $p): ?>
                                <img src="<?= base_url('assets/images/partner/' . $p['logo']) ?>" 
                                     style="width: 50px; height: 50px; object-fit: contain; background: white; padding: 5px; border: 1px solid #ddd; border-radius: 4px;" 
                                     title="<?= $p['nama_partner'] ?>">
                            <?php endforeach; ?>
                            <?php if(count($partner) > 5): ?>
                                <div style="width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; background: #eee; border-radius: 4px; font-size: 0.8rem; font-weight: 700;">
                                    +<?= count($partner) - 5 ?>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <a href="<?= base_url('admin/partner') ?>" class="edit-link">
                    Edit Halaman Partner <i class="bi bi-arrow-right-circle-fill"></i>
                </a>
            </div>
